...
# .data implementa a secao de dados do programa.
.data	
	primeira_palavra: .word 1
	segunda_palavra: .word 1
	terceira_palavra: .word 0x10000000

# .text implementa a secao de instrucoes do programa.
.text
# O trecho de dados do MARS comeca em 0X00001001, por isso ha a necessidade do LUI. O registrador 
# $10 serve de ponteiro para a base dos dados.
