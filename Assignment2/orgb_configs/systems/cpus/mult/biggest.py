...
class MyIntMultDiv(FUDesc):
    opList = [ OpDesc(opClass='IntMult', opLat=16, pipelined=True),
...
############################################################
    ...
    numPhysIntRegs   =  128 # Number of physical integer registers #! Alteracao 2: 96 -> 128
